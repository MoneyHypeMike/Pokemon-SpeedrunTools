...
"y": {"any% nsc": "World record for Pokémon Yellow (any% nsc): No console time have been submitted for this game.",
      ...
      "151 pokedex": "World record for Pokémon Yellow (151 pokedex): No console time have been submitted for this game."},
...
"xd":  {"any%": "World record for Pokémon XD: Gale of Darkness (any%): 4:56 (IGT) by LBlueEagle (http://goo.gl/IDb9dA)."},
...
"bw": {"any% glitchless": "World record for Pokémon Black/White (any% glitchless): 3:30 (IGT) Vulajin (http://goo.gl/z8NwOi)."},
